	...
	services.syncthing = {
		...
		devices = let
			...
			graphical-test-vm-device = {
				"Graphical-Test-VM" = { id = "AEU6Q56-L5J3AGY-Z4H6S4A-JZH6VPO-DXI66VM-GFBDSGT-CQQTNMY-TKH6CQY"; };
			};
			laptop-device = {
		...
		in
		{
			...
			"Jason-Lemur-Pro-VM-Test" = { id = "MRLHROA-JB6ZV7Y-QQORSLQ-SQ5DOBW-3DCCF6Q-C4VWYKL-UFI7EDD-B6THXQB"; };
